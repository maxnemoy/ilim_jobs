...
abstract class ApiClient {
  ...
  ///[POST]
  @PUT("/v1/post")
  Future<RespData> createPost(@Body() PostData post, @Header("Authorization") String token);

  @PATCH("/v1/post")
  Future<RespData> updatePost(@Body() PostData post, @Header("Authorization") String token);
  ...
  ///[POST.type]
  @PUT("/v1/post/type")
  Future<RespData> createPostType(@Body() PostTypeData postType, @Header("Authorization") String token);

  @PATCH("/v1/post/type")
  Future<RespData> updatePostType(@Body() PostData postType, @Header("Authorization") String token);
  ...
  ///[VACANCY]
  @PUT("/v1/vacancy")
  Future<RespData> createVacancy(@Body() VacancyData vacancy, @Header("Authorization") String token);

  @PATCH("/v1/vacancy")
  Future<RespData> updateVacancy(@Body() VacancyData vacancy, @Header("Authorization") String token);
  ...
  ///[VACANCY.tag]
  @PUT("/v1/vacancy/tag")
  Future<RespData> createVacancyTag(@Body() VacancyTagData tag, @Header("Authorization") String token);

  @PATCH("/v1/vacancy/tag")
  Future<RespData> updateVacancyTag(@Body() VacancyTagData tag, @Header("Authorization") String token);
  ...
  Future<RespData> createVacancyCategory(@Body() VacancyCategoryData category, @Header("Authorization") String token);

  @PATCH("/v1/vacancy/category")
  Future<RespData> updateVacancyCategory(@Body() VacancyCategoryData category, @Header("Authorization") String token);
