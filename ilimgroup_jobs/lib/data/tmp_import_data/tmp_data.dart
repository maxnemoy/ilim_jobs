...
TmpData tmpData = TmpData(
  ...
  category: [
    ...
    VacancyCategoryData(category: "Охрана труда и пожарная безопасность", description: ""),
    ...
    VacancyCategoryData(category: "Управление цепочкой поставок и логистика", description: ""),
